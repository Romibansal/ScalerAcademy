...
//        There is a football event going on in your city. In this event, you are given A
//        passes and players having ids between 1 and 106.
//
...
//        2) 0
//
//        For the first kind of pass, the player in possession of the ball passes the ball
//        "forward" to the player with id = ID.
//
//        For the second kind of pass, the player in possession of the ball passes the ball
//        back to the player who had forwarded the ball to him.
//
...
public class PassingGame {
    ...
    public static void main(String[] args) {
        PassingGame I = new PassingGame();
        int C[]=new int[10];
        C[0]=86;C[1]=63;C[2]=60;C[3]=0;
        C[4]=47;C[5]=0;C[6]=99;C[7]=9;
        C[8]=0;C[9]=0;
        System.out.println(I.solve(10,23,C));
    }
}
