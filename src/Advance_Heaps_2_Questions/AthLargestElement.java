...
import Advance_Heaps_1_Intro.MaximumArraySumAfterBNegations;
...
//        where i varies from 1 to N. In other words, find the Ath largest element in
//        the sub-arrays [1 : 1], [1 : 2], [1 : 3], ...., [1 : N].
//
...
public class AthLargestElement {
    ...
    public static void main(String[] args) {
        AthLargestElement I = new AthLargestElement();
        ArrayList<Integer>A=new ArrayList<>();
        A.add(15);A.add( 20);A.add( 99);A.add( 1);

        System.out.println( I.solve(2,A));
    }
}
